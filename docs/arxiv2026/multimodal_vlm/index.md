...
**[Beyond Single-Sample: Reliable Multi-Sample Distillation for Video Understanding](beyond_singlesample_reliable_multisample.md)**

:   大型视觉语言模型 (LVLM) 的传统黑盒蒸馏通常依赖于每个输入的单个教师响应，这通常会在多模式或时间场景中产生高方差响应和格式不一致。

**[BiCLIP: Bidirectional and Consistent Language-Image Processing for Robust Medical Image Segmentation](biclip_bidirectional_consistent_languageimage.md)**
...
**[Revisiting Model Stitching In the Foundation Model Era](revisiting_model_stitching_foundation.md)**

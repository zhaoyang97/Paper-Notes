...
description: >-
  [CVPR 2026][VLM Reasoning][物理学习] PhysInOne是一个包含153,810个动态3D场景和200万个标注视频的大规模合成数据集，覆盖力学、光学、流体动力学和磁学的71种基本物理现象，为物理感知的世界模型建立了新基准。 领域现状：当前AI模型在物理世界理解上严重不足——AI生成的视频频繁违反基…
tags:
  - "CVPR 2026"
  - "VLM Reasoning"
  - "物理学习"

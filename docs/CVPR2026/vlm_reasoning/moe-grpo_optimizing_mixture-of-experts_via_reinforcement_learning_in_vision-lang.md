...
description: >-
  [CVPR 2026][VLM Reasoning][混合专家] 将 MoE 中的专家选择建模为序列决策问题，通过 GRPO 强化学习优化路由策略，引入模态感知路由引导，在 VLM 的图像和视频理解任务上一致超越确定性 top-K 路由及其变体。 领域现状：Mixture-of-Experts (MoE) 通过稀疏激活子集参…
tags:
  - "CVPR 2026"
  - "VLM Reasoning"
  - "混合专家"

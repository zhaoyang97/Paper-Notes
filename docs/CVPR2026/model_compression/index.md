---
title: >-
  CVPR2026 模型压缩论文汇总 · 108篇论文解读
description: >-
  108篇CVPR2026的模型压缩方向论文解读，涵盖压缩/编码、扩散模型、模型压缩、多模态、知识蒸馏、目标跟踪等方向。覆盖该方向前沿研究进展与技术创新，每篇含一句话总结、核心思想、方法详解、实验结果与局限性分析，5分钟读懂一篇论文核心思想。
tags:
  - "CVPR2026"
  - "模型压缩"
  - "论文解读"

...
**[AndroidGen: Building an Android Language Agent under Data Scarcity](others/androidgen_agent_data_scarcity.md)**
...
**[AndroidLab: Training and Systematic Benchmarking of Android Autonomous Agents](others/androidlab_autonomous_agent.md)**
...
**[CodeDPO: Aligning Code Models with Self Generated and Verified Source Code](others/codedpo_code_alignment.md)**
...
**[Astute RAG: Overcoming Imperfect Retrieval Augmentation and Knowledge Conflicts for Large Language Models](llm_agent/astute_rag_knowledge_conflicts.md)**
...
**[Beware of Your Po! Measuring and Mitigating AI Safety Risks in Role-Play Fine-Tuning of LLMs](ai_safety/sarft_roleplay_safety.md)**
...
**[MHA2MLA: Towards Economical Inference by Enabling DeepSeek's Multi-Head Latent Attention in Any Transformer-based LLMs](llm_efficiency/mha2mla_deepseek_latent_attention.md)**

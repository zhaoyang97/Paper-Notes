...
**[HyCAS：用混合卷积与注意力随机性，同时打通认证鲁棒与经验鲁棒](certified_vs_empirical_adversarial_robustness_via_hybrid_convolutions_with_atten.md)**
...
**[STEDiff：揭示文生图扩散模型后门攻击中的时空冗余](stediff_revealing_the_spatial_and_temporal_redundancy_of_backdoor_attacks_in_tex.md)**
...
**[TriQDef：扰乱语义与梯度对齐，阻断量化网络中的对抗补丁迁移](triqdef_disrupting_semantic_and_gradient_alignment_to_prevent_adversarial_patch_.md)**

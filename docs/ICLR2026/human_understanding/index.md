...
**[DenseMarks：通过点轨迹学习人头图像的规范嵌入](densemarks_learning_canonical_embeddings_for_human_heads_images_via_point_tracks.md)**
...
**[EdgeCAPE：边权预测用于类别无关姿态估计](edgecape_edge_weight_prediction_for_category-agnostic_pose_estimation.md)**
...
**[Sapiens2：面向人体视觉的高分辨率基础模型](sapiens2.md)**

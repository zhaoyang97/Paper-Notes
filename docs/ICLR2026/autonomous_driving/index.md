---
title: >-
  ICLR2026 自动驾驶论文汇总 · 40篇论文解读
description: >-
  40篇ICLR2026的自动驾驶方向论文解读，涵盖自动驾驶、Agent、多模态、对抗鲁棒、对齐/RLHF、扩散模型等方向。覆盖该方向前沿研究进展与技术创新，每篇含一句话总结、核心思想、方法详解、实验结果与局限性分析，5分钟读懂一篇论文核心思想。
tags:
  - "ICLR2026"
  - "自动驾驶"
  - "论文解读"
...
item_list:
  ...
  - u: "plan-r1_safe_and_feasible_trajectory_planning_as_language_modeling/"
    t: "Plan-R1: Safe and Feasible Trajectory Planning as Language Modeling"
  - u: "ptnet_a_proposal-centric_transformer_net-_work_for_3d_object_detection/"
    t: "PTN：面向 3D 目标检测的提案中心化 Transformer 网络"
  - u: "rate-distortion_optimized_pragmatic_communication_for_collaborative_perception/"
    t: "Rate-Distortion Optimized Pragmatic Communication for Collaborative Perception"
  - u: "recogdrive_a_reinforced_cognitive_framework_for_end-to-end_autonomous_driving/"
    t: "ReCogDrive: A Reinforced Cognitive Framework for End-to-End Autonomous Driving"
...
🔥 **高频主题：** 自动驾驶 ×13 · Agent ×4 · 多模态 ×4 · 对抗鲁棒 ×3 · 对齐/RLHF ×3
...
**[PTN：面向 3D 目标检测的提案中心化 Transformer 网络](ptnet_a_proposal-centric_transformer_net-_work_for_3d_object_detection.md)**

...
**[PLAGUE: 终身学习驱动的多轮越狱即插即用框架](plague_plug-and-play_framework_for_lifelong_adaptive_generation_of_multi-turn_ja.md)**
...
**[SafeDialBench：面向大模型多轮对话与多样越狱攻击的细粒度安全评估基准](safedialbench_a_fine-grained_safety_evaluation_benchmark_for_large_language_mode.md)**
...
**[Trust The Typical：把 LLM 安全护栏当作分布外检测来做](trust_the_typical.md)**
...
**[TrustGen：生成式基础模型可信度的动态评测平台](trustgen_a_platform_of_dynamic_benchmarking_on_the_trustworthiness_of_generative.md)**

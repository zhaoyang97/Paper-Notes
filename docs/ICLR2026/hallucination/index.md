...
item_list:
  - u: "after_mitigating_the_object_hallucination_of_lvlm_via_adaptive_factual-guided_ac/"
    t: "AFTER: 用自适应事实引导的激活编辑缓解 LVLM 的物体幻觉"
...
**[Critical Confabulation: Can LLMs Hallucinate for Social Good?](critical_confabulation_can_llms_hallucinate_for_social_good.md)**

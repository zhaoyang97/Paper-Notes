...
**[ReVeal: 通过可靠自验证实现自进化的代码智能体](reveal_self-evolving_code_agents_via_reliable_self-verification.md)**
...
**[Terminal-Bench：在命令行界面上对智能体进行困难、真实任务的基准测试](terminal-bench_benchmarking_agents_on_hard_realistic_tasks_in_command_line_inter.md)**

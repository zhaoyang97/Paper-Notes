...
description: >-
  [ICLR2026][VLM Reasoning][multi-view spatial reasoning] 提出 MV-RoboBench，首个整合多视角空间推理与机器人操作执行评测的 benchmark，包含 1.7K 人工标注 QA，揭示当前最强 VLM（GPT-5 仅 56.4%）与人类（91.0%）之间存在巨大差距。
tags:
  - "ICLR2026"
  - "VLM Reasoning"

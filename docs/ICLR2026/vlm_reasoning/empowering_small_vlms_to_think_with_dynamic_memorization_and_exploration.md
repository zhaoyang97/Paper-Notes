...
description: >-
  [ICLR 2026][VLM Reasoning][小规模视觉语言模型] 提出 DyME（Dynamic Memorize-Explore），通过逐步动态切换 SFT 记忆模式与 GRPO 探索模式，首次赋予小规模视觉语言模型（<1B 参数）在特定任务上的思维推理能力。 - 大模型（如 Qwen2.5-VL-32B）可通过…
tags:
  - "ICLR 2026"
  - "VLM Reasoning"
  - "小规模视觉语言模型"

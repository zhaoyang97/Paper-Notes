...
**[LaplacianFormer：用拉普拉斯核重新思考线性注意力](laplacianformerrethinking_linear_attention_with_laplacian_kernel.md)**
...
**[Vulcan: 为边缘智能裁剪紧凑的类特定视觉 Transformer](vulcan_crafting_compact_class-specific_vision_transformers_for_edge_intelligence.md)**
...
**[WSVD: Weighted Low-Rank Approximation for Fast and Efficient Execution of Low-Precision Vision-Language Models](wsvd_weighted_low-rank_approximation_for_fast_and_efficient_execution_of_low-pre.md)**

...
## 研究背景与动机
1. **领域现状**：本文研究的问题属于 文本生成 方向。In this paper, we speed up robust two-view relative pose from dense correspondences.
...
### 主实验
基于摘要的实验信息：To avoid this, we propose an efficient match summarization scheme which provides comparable accuracy to using the full set of dense matches, while having 10-100x faster runtime. We validate our approach on standard benchmark datasets together with multiple state-of-the-art dense matchers.
